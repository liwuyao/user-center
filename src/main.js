...
config => {
    ...
    if(store.state.queryClientKey){
    	config.headers.queryClientKey = store.state.queryClientKey;
    }else{
    	config.headers.queryClientKey = Vue.prototype.getMyWeb.queryClientKey;
    }
    return config
},
error => {
